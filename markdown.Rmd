...
prop.test(baltimore_proptest$total_unsolved, baltimore_proptest$total)
## prop.test = unsolved/total
complete_table = 
  inner_join(total, unsolved, homicides, by = "city_state")
...
complete_table = as.tibble(complete_table)
complete_table
complete_table =
  complete_table %>% 
